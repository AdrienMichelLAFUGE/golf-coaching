    ...
    <div className="space-y-6">
      ...
      <section className="panel rounded-2xl p-6">
        <div className="grid gap-3 text-sm text-[var(--muted)]">
          <div className="grid grid-cols-[1.5fr_1fr_0.9fr] gap-3 uppercase tracking-wide text-[0.7rem] text-[var(--muted)]">
            <span>Eleve</span>
            <span>Email</span>
            <span>Acces</span>
          </div>
          {loading ? (
            ...
            filteredStudents.map((student) => (
              <div
                key={student.id}
                className="grid grid-cols-[1.5fr_1fr_0.9fr] gap-3 rounded-xl border border-white/5 bg-white/5 px-4 py-3 text-[var(--text)]"
              >
