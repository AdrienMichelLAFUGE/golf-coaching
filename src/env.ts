...
const serverSchema = z.object({
  ...
  STRIPE_AI_CREDIT_PRICE_5_ID: z.string().min(1).optional(),
  STRIPE_AI_CREDIT_PRICE_10_ID: z.string().min(1).optional(),
  STRIPE_AI_CREDIT_PRICE_20_ID: z.string().min(1).optional(),
...
const buildTestEnv = () => ({
  ...
  STRIPE_AI_CREDIT_PRICE_5_ID: "price_ai_credit_5_test",
  STRIPE_AI_CREDIT_PRICE_10_ID: "price_ai_credit_10_test",
  STRIPE_AI_CREDIT_PRICE_20_ID: "price_ai_credit_20_test",
